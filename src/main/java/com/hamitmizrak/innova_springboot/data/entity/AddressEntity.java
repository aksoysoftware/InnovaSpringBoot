...
public class AddressEntity extends BaseEntity{
    ...
    */
    ...
    public AddresseEntityDetailsEmbedable getAddresseEntityDetailsEmbedable() {
        return addresseEntityDetailsEmbedable;
    }



    public AddresseEntityDetailsEmbedable getAddressDetailsEmbedable() {
        return addresseEntityDetailsEmbedable;
    }

    public void setAddressDetailsEmbedable(AddresseEntityDetailsEmbedable addressDetailsEmbedable) {
        addresseEntityDetailsEmbedable = addresseEntityDetailsEmbedable;
    }
